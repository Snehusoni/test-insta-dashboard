...
const createNavigationItems = (
	...
	},
	{
	    icon: <Users />,
	    label: "Users",
	    onClick: () => handleItemChange("Users"),
},
{
	icon: <FileText />,
	label: "Report",
	onClick: () => handleItemChange("Report"),
},
	{
		icon: (
			<Image
...
const Sidebar = () => {
	...
	return (
		<aside className="border-r border-gray-200 h-screen lg:w-64 sm:w-20 sm:p-4 w-14 p-1 py-8 pb-6 flex flex-col bg-gray-50">
			<InstagramLogo />
