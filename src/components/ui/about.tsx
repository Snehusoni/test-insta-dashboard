...
const About = ({
	...
	return (
		<div className="flex-1 overflow-y-auto">
			<div className="max-w-4xl mx-auto p-8 pl-4 sm:pl-8">
				{/* Profile Header */}
				<div className="flex items-start gap-2 sm:gap-4 md:gap-8 mb-8">
					{/* Profile Picture */}
					<div className="relative w-16 h-16 sm:w-28 sm:h-28 md:w-36 md:h-36 lg:w-40 lg:h-40 flex-shrink-0">
						<Image
